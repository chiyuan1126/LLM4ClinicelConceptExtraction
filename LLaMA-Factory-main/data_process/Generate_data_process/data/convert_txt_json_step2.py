...
if __name__ == "__main__":
    input_file_path = "data/AggregationCorpus/SentenceData/i2b2-2010/train_processed.txt"
    output_file_path = "data/AggregationCorpus/SentenceData/i2b2-2010/train_processed.json"
